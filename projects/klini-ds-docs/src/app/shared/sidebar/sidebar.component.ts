  ...
  template: `
    <nav class="docs-sidebar sidebar" aria-label="Navegacao principal">
      ...
      <div class="sidebar__section">
        <div class="sidebar__section-label" id="nav-inicio">Inicio</div>
        <a routerLink="/" routerLinkActive="active" [routerLinkActiveOptions]="{ exact: true }"
           class="sidebar__link sidebar__link--top"
           [attr.aria-current]="isActive('/') ? 'page' : null">Visao Geral</a>
        <a routerLink="/getting-started" routerLinkActive="active"
           class="sidebar__link sidebar__link--top"
           [attr.aria-current]="isActive('/getting-started') ? 'page' : null">Instalacao</a>
        <a routerLink="/tokens" routerLinkActive="active"
           class="sidebar__link sidebar__link--top"
           [attr.aria-current]="isActive('/tokens') ? 'page' : null">Design Tokens</a>
        <a routerLink="/icons" routerLinkActive="active"
           class="sidebar__link sidebar__link--top"
           [attr.aria-current]="isActive('/icons') ? 'page' : null">
      ...
      <div class="sidebar__section">
        ...
        <a routerLink="/charts" routerLinkActive="active"
           ...
           [attr.aria-current]="isActive('/charts') ? 'page' : null">
        ...
        <a routerLink="/components/chart" routerLinkActive="active"
           class="sidebar__link sidebar__link--top"
           [attr.aria-current]="isActive('/components/chart') ? 'page' : null">kln-chart API</a>
      </div>
      ...
      <div class="sidebar__section">
        ...
        @for (item of buttonItems; track item.route) {
          <a [routerLink]="item.route" routerLinkActive="active"
             class="sidebar__link"
             [attr.aria-current]="isActive(item.route) ? 'page' : null">{{ item.label }}</a>
        }
        ...
        <a routerLink="/components/portal-templates" routerLinkActive="active"
           class="sidebar__link"
           [attr.aria-current]="isActive('/components/portal-templates') ? 'page' : null">
          Portal Templates
        </a>
      </div>
    </nav>
...
export class SidebarComponent {
  ...
  isActive(route: string): boolean {
    return window.location.hash === '#' + route || window.location.hash === '#' + route + '/';
  }
